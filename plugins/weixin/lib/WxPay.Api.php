...
class WxPayApi
{
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function unifiedOrder($inputObj, $timeOut = 6, $type='JS')
	{
    ...
    public static function redpack($inputObj, $timeOut = 6)
    {
        ...
        $inputObj->values['wxappid'] = WxPayConfig::$appid;//公众账号ID
        $inputObj->values['mch_id'] = WxPayConfig::$mchid;//商户号
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function orderQuery($inputObj, $timeOut = 6, $isapp=0)
	{
